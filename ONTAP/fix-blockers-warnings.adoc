...
---
= Corrija os bloqueios e avisos do ONTAP em atualizações de software
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Identifique a versão de destino do ONTAP para o seu sistema de storage. Para obter informações sobre como identificar a versão de destino do ONTAP, consulte link:../ONTAP/choose-ontap-910-later.html["Compare as versões do ONTAP com as atualizações de software"].
