...
---
= Guia rápido para atualizar o ONTAP em atualizações de software
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
link:../ONTAP/validate-storage-system-update.html["Valide o status de uma atualização do ONTAP nas atualizações de software"].
